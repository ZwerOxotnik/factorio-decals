...
Add https://mods.factorio.com/mod/decals in your dependencies
...
echo "# Add string \"decals\" in dependencies of ${MOD_NAME}/info.json, example: '\"dependencies\": [\"decals >= 2.0.0\"]'"
